...
const ariaClosed = __('Show more tools & options', 'rehub-theme-child');
const ariaOpen = __('Hide more tools & options', 'rehub-theme-child');
			...
			<PanelBody>
				<div className="rehub-url-input-popover__input-wrapper">
					...
					<TextControl
						...
						onChange={props.onChange}
						autoFocus={false} // eslint-disable-line
						placeholder={__('Paste or type URL', 'rehub-theme-child')}
					/>
					}
				...
				<ToggleControl
					label={__('Open link in new tab', 'rehub-theme-child')}
				...
				<ToggleControl
					label={__('Nofollow link', 'rehub-theme-child')}
				...
				<ToggleControl
					label={__('Open link in modal', 'rehub-theme-child')}
				...
				<TextControl
					...
					autoFocus={false}
					placeholder={__('Modal ID', 'rehub-theme-child')}
				/>
				}
			</PanelBody>
		</Popover>
