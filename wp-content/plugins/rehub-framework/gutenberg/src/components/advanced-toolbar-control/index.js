...
const FLEX_HORIZONTAL_ALIGN_OPTIONS = [
	{
		value: 'flex-start',
		title: __('Align Left', 'rehub-theme-child'),
		icon: <SVGIconLeft/>,
	},
	{
		value: 'center',
		title: __('Align Center', 'rehub-theme-child'),
		icon: <SVGIconHorizontalCenter/>,
	},
	{
		value: 'flex-end',
		title: __('Align Right', 'rehub-theme-child'),
		icon: <SVGIconRight/>,
	},
];
...
const FLEX_VERTICAL_ALIGN_STRETCH_OPTIONS = [
	{
		value: 'flex-start',
		title: __('Align Top', 'rehub-theme-child'),
		icon: <SVGIconTop/>,
	},
	{
		value: 'center',
	...
	{
		value: 'flex-end',
		title: __('Align Bottom', 'rehub-theme-child'),
		icon: <SVGIconBottom/>,
	},
	{
		value: 'stretch',
		title: __('Stretch', 'rehub-theme-child'),
		icon: <SVGIconStretch/>,
	},
];
